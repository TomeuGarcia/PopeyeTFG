namespace Popeye.ProjectHelpers
{
    public static class ScriptableObjectsHelper
    {
        ...
        public const string PLAYERSPECIALATTACKS_ASSETS_PATH = PLAYER_ASSETS_PATH + "SpecialAttacks/";
        ...
        public const string INFORMATIONDISPLAY_ASSETS_PATH = ROOT + "InformationDisplay/";
