...
namespace Popeye.Modules.CombatSystem
{
    ...
    public class CombatManagerSingleton : MonoBehaviour, ICombatManager
    {
        public static CombatManagerSingleton Instance { get; private set; }
        ...
        public DamageHitTargetType DamageEnemiesDestructiblesAndInteractablesPreset =>
            _damageEnemiesDestructiblesAndInteractablesPreset;
        ...
        private void AwakeInit()
        {
            ...
            DamageHitTargetTypeUtilities.AddType(ref _damageEnemiesAndDestructiblesPreset,
                DamageHitTargetType.Destructible);

            DamageHitTargetTypeUtilities.AddType(ref _damageEnemiesDestructiblesAndInteractablesPreset,
                DamageHitTargetType.Enemy);
            DamageHitTargetTypeUtilities.AddType(ref _damageEnemiesDestructiblesAndInteractablesPreset,
                DamageHitTargetType.Destructible);
            DamageHitTargetTypeUtilities.AddType(ref _damageEnemiesDestructiblesAndInteractablesPreset,
                DamageHitTargetType.Interactable);
