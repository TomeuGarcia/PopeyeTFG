...
public class ParabolicProjectile : RecyclableObject
{
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        { 
            _contactDamageHit.Position = transform.position;
            _contactDamageHit.KnockbackDirection = PositioningHelper.Instance.GetDirectionAlignedWithFloor(transform.position, other.transform.position);
