...
namespace Popeye.Modules.VFX.Water
{
    public class WaterShoreCapturer : MonoBehaviour
    {
        ...
        private IEnumerator LoadedScene()
        {
            ...
            _waterMeshRenderer.material.SetVector("_ShoreTextureOffset",
                new Vector4(_camera.gameObject.transform.position.x, _camera.gameObject.transform.position.z, 0.0f,
                    0.0f));
        }
        ...
        {
            _eventSystemService
                .Unsubscribe<IGameStateEventsDispatcher.OnFinishLoadingScenes>(OnFinishLoadingSceneEvent);
        }
    }
