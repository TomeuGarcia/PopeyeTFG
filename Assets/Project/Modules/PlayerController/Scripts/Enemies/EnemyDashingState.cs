...
namespace Popeye.Modules.Enemies.StateMachine
{
    public class EnemyDashingState : IEnemyState
    {
        ...
        public EnemyDashingState(Enemy enemy, float dashPrepareDuration, float dashExecutionDuration,
        ...
        private void ComputeDashStartPosition()
        {
            ...
            _dashStartPosition =
                PositioningHelper.Instance.GetGoalPositionCheckingObstacles(_enemy.Position, _dashStartPosition,
        ...
        private void ComputeDashEndPosition()
        {
            ...
            _dashEndPosition =
                PositioningHelper.Instance.GetGoalPositionCheckingObstacles(_enemy.Position, _dashEndPosition,
                    out float distanceRatio);
        }
